...
- [SOLIDs](https://github.com/sounak07/engineering-prep-hub/blob/main/LLD/solids.md)
...
- [Decorator Pattern](https://github.com/sounak07/engineering-prep-hub/blob/main/LLD/patterns/decorator_pattern.py)
- [Observer Pattern](https://github.com/sounak07/engineering-prep-hub/blob/main/LLD/patterns/observer_pattern.py)
- [Strategy Pattern](https://github.com/sounak07/engineering-prep-hub/blob/main/LLD/patterns/strategy_pattern.py)
...
- [Amazon Bedrock for buidling agents](https://aws-samples.github.io/amazon-bedrock-samples/)
...
- [Advanced Python for Senior Engineers](https://github.com/Rustam-Z/senior-python-engineer)
- [Super Fast Python](https://superfastpython.com)
- [Ten Thousand Meters (Python)](https://tenthousandmeters.com/tag/cpython/)
- [Top Concurrency Questions](https://www.educative.io/blog/top-five-concurrency-interview-questions-for-software-engineers)
- [Top 40 Concurrency Questions in Python](https://github.com/Devinterview-io/concurrency-interview-questions)
- [Python Concurrency](https://github.com/MeSabya/PythonConcurrency-)
- [Python Patterns](https://github.com/faif/python-patterns)
- [Python Trips and tricks](https://www.youtube.com/playlist?list=PL9_iFHfnv8hB5I0lhK463F3k-HUJV-Xxj)
- [Code Smells Python](https://www.youtube.com/playlist?list=PLC0nd42SBTaNILCJRCd4DvzNueVN_Sr5R)
